...
{
   g_notifier.Send(_Symbol, message);
}
...
int OnInit()
{
   ...
   g_notifier.Init("EA_ImpulseZigZag", EnableAlerts, EnablePushNotifications, EnableEmailNotifications);
...
void ExecuteTrade(int symbolIndex)
{
   ...
   // Calculate lot size using shared executor
   double lotSize = g_executor.CalculateLotSize(
      symbolDataArray[symbolIndex].symbol, RiskPercent,
